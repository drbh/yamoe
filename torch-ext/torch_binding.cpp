...
TORCH_LIBRARY_EXPAND(
  ...
  ops.def("experts_static("
          ...
          "int num_experts, "
          "int top_k) -> Tensor");
  ops.impl("experts_static", torch::kCUDA, &experts_static_cuda);

  ops.def("experts_gather("
          "Tensor hidden_states, "
          "Tensor router_indices, "
          "Tensor routing_weights, "
          "Tensor gate_up_proj, "
          ...
          "int num_experts, "
          "int top_k) -> Tensor");
  ops.impl("experts_gather", torch::kCUDA, &experts_gather_cuda);
